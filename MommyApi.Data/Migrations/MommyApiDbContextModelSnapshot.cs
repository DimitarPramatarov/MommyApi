...
namespace MommyApi.Data.Migrations
{
    ...
    partial class MommyApiDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MommyApi.Data.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MommyApi.Data.Models.Answer", b =>
                {
                    b.HasOne("MommyApi.Data.Models.Post", "Post")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("MommyApi.Data.Models.Post", b =>
                {
                    b.HasOne("MommyApi.Data.Models.User", "User")
                        .WithMany("Post")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("MommyApi.Data.Models.SubAnswer", b =>
                {
                    b.HasOne("MommyApi.Data.Models.Answer", "Answer")
                        .WithMany("SubAnswers")
            ...
            modelBuilder.Entity("MommyApi.Data.Models.User", b =>
                {
                    b.HasOne("MommyApi.Data.UserProfile", "UserProfile")
                        .WithMany()
